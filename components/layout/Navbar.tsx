...
export function Navbar() {
  ...
  // The cart store is persisted to localStorage, which rehydrates on the client
  // before the first paint but doesn't exist on the server — so `itemCount` can
  // already be >0 on the client's first render while the server always rendered
  // 0. Gate the badge on mount so the first client render still matches the
  // server (no badge), then reveal it in a normal post-hydration update.
      ...
      <div className="max-w-8xl mx-auto flex items-center justify-between px-5 lg:px-8 h-full relative border-b-[1px] border-[#121212] border-opacity-70">
        ...
        <ul className="hidden lg:flex flex-1 justify-center gap-14 lg:gap-20 font-medium text-black h-full items-stretch">
              ...
              <div className="bg-white shadow-[0px_0px_60px_5px_rgba(0,0,0,0.25)] border border-gray-100">
                <div className="flex flex-col px-[30px] py-[30px]">
                  ...
                  >
                    ...
                    <IconChevronRight className="w-4 h-4 text-[#045830] nav-arrow !mt-[2px]" />
                  </Link>
                </div>
              </div>
            </div>
          ...
          <li className="relative h-full flex items-center">
            <Link href="/testimonial" className="txt-header-desktop flex items-center gap-1.5 cursor-pointer hover:opacity-80 py-4 relative after:absolute after:bottom-0 after:left-0 after:h-[3px] after:w-0 hover:after:w-full after:bg-primary after:transition-all after:duration-300">Testimonials</Link>
          </li>

          {/* FREE Consultation */}
          <li className="relative h-full flex items-center">
            <Link href="/contact" className="txt-header-desktop flex items-center gap-1.5 cursor-pointer hover:opacity-80 py-4 relative after:absolute after:bottom-0 after:left-0 after:h-[3px] after:w-0 hover:after:w-full after:bg-primary after:transition-all after:duration-300">FREE Consultation</Link>
          </li>

          {/* Blog */}
          <li className="relative h-full flex items-center">
            <Link href="/blog" className="txt-header-desktop flex items-center gap-1.5 cursor-pointer hover:opacity-80 py-4 relative after:absolute after:bottom-0 after:left-0 after:h-[3px] after:w-0 hover:after:w-full after:bg-primary after:transition-all after:duration-300">Blog</Link>
          </li>
        </ul>
              ...
              <div className="flex flex-col min-h-full">
                ...
                <div className="flex flex-col gap-[30px] pt-[30px] pb-[15px] px-[25px]">
                  <span
                    ...
                    className="flex items-center txt-header-mobile text-[#111] hover:text-[#0A5B2E] transition-colors cursor-pointer"
                  >
